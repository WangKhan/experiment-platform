<template>
  <div class="login_container">
    <h1 style="color: #dddddd;margin: 0;padding:40px 15px ; text-align: center">数字图像处理在线实验系统</h1>
    <div class="login_box">
      <!-- 头像区域 -->
      <!-- 登录表单区域 -->
      <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
        ...
        <el-form-item prop="id">
          <el-input v-model="loginForm.id" prefix-icon="el-icon-user-solid" placeholder="请输入学号或管理员账号"></el-input>
        </el-form-item>
        <!-- 密码 -->
